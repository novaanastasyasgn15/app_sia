                ...
                <div class="text-end p-3">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="?modul=profile"><i class="bi bi-person-badge-fill"></i> Profile</a></li>
                            <li><a class="dropdown-item" href="logout.php"><i class="bi bi-door-closed-fill"></i> Logout</a></li>
                        </ul>
                    </div>
                </div>
                <div class="p-3">
