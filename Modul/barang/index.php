...
<div class="card">
 ...
 <td>5</td>
 <td>
 <a href="#editBarang" class="text-decoration-none" data-bstoggle="modal">
 ...
 <!-- Modal -->
 <div class="modal fade" id="editBarang" tabindex="-1" arialabelledby="exampleModalLabel" aria-hidden="true">
...
value="5">
 ...
 <td>10</td>
 <td>
 <a href="#editBarang" class="text-decoration-none" databs-toggle="modal">
 <i class="bi bi-pencil-square text-success"></i>
 </a>
 <a href="" class="text-decoration-none">
 <i class="bi bi-trash text-danger"></i>
